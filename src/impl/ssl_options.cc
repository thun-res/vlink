...
SslOptions SslOptions::parse_from(const Conf::PropertiesMap& properties) noexcept {
  ...
  const std::string env_verify = Utils::get_env("VLINK_SSL_VERIFY");
  const std::string env_ca = Utils::get_env("VLINK_SSL_CA");
  const std::string env_cert = Utils::get_env("VLINK_SSL_CERT");
  const std::string env_key = Utils::get_env("VLINK_SSL_KEY");
  const std::string env_key_pass = Utils::get_env("VLINK_SSL_KEY_PASS");
  const std::string env_sni = Utils::get_env("VLINK_SSL_SNI");
  const std::string env_ciphers = Utils::get_env("VLINK_SSL_CIPHERS");
