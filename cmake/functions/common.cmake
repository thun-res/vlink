...
function(vlink_test_warn target)
  ...
  elseif(QNX)
    ...
    target_compile_options(
      ${target} PUBLIC -Wno-maybe-uninitialized -Wno-uninitialized -Wno-array-bounds -Wno-stringop-overflow
...
function(vlink_test_coverage_by_lcov target excludes options)
  ...
  if(LCOV_VERSION AND LCOV_VERSION VERSION_GREATER_EQUAL "2.0")
    ...
    set(LCOV_IGNORE_ERRORS "mismatch,mismatch,inconsistent,inconsistent,negative,negative,range,range")
    set(LCOV_FILTER_ARGS "")
    if(LCOV_HELP_OUTPUT MATCHES "--filter")
      set(LCOV_FILTER_ARGS "--filter branch --filter function --filter range --filter branch_region")
    endif()
    set(LCOV_OMIT_ARGS "")
    ...
    set(LCOV_EXT_ARGS
        "--rc branch_coverage=1 --quiet --rc check_data_consistency=0 --rc lcov_excl_br_line=${LCOV_BRANCH_EXCL_REGEX} --ignore-errors ${LCOV_IGNORE_ERRORS} ${LCOV_FILTER_ARGS} ${LCOV_OMIT_ARGS} ${options}"
    )
  else()
