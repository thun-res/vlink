...
class VLINK_EXPORT Plugin final {
 public:
   ...
   *
   * @details
   * The list contains, in priority order, directories from @c VLINK_PLUGIN_DIR
   * (comma or whitespace separated), the current working directory, the executable
   * directory, and the system library directories appropriate for the platform.
   *
