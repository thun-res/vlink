 ...
 *       @c true (enforced by @c static_assert in the response-bearing entry
 *       points; the @c std::optional -returning overload inherits the
 *       constraint by delegating to the out-parameter @c invoke).
 *
