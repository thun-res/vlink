...
class VLINK_EXPORT NodeImpl {
 public:
  ...
  /**
   * @brief Registers the node with the runtime-owned discovery reporter.
   *
   * @details
  ...
  /**
   * @brief Deregisters the node from the runtime-owned discovery reporter.
   *
   * @details
   ...
   *
   * @details
   * Brings the logger, memory pool, and global bag writer online, and prepares the
   * runtime-owned discovery reporter holder without starting the reporter until a
   * discoverable node is registered.  Safe to call multiple times; only the first
   * call has an effect. The base constructor invokes this automatically.
   */
