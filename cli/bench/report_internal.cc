...
std::vector<AggregatedCase> aggregate_cases(const Bench::Result& result) {
  ...
  std::sort(items.begin(), items.end(), [](const AggregatedCase& lhs, const AggregatedCase& rhs) {
    return std::forward_as_tuple(static_cast<int>(lhs.scenario.suite), static_cast<int>(lhs.scenario.mode),
                                 static_cast<int>(lhs.scenario.topology), static_cast<int>(lhs.scenario.rate_pattern),
                                 static_cast<int>(lhs.scenario.payload), lhs.url_order_index, lhs.transport,
                                 lhs.scenario.url, lhs.scenario.qos_profile, lhs.scenario.properties,
                                 lhs.scenario.pub_properties, lhs.scenario.sub_properties, lhs.scenario.publishers,
                                 lhs.scenario.subscribers, lhs.scenario.payload_size, lhs.scenario.rate_hz,
                                 lhs.scenario.burst_messages, lhs.scenario.subscriber_sleep_us, lhs.scenario.warmup_ms,
                                 lhs.scenario.duration_ms, lhs.scenario.drain_ms) <
           std::forward_as_tuple(static_cast<int>(rhs.scenario.suite), static_cast<int>(rhs.scenario.mode),
                                 static_cast<int>(rhs.scenario.topology), static_cast<int>(rhs.scenario.rate_pattern),
                                 static_cast<int>(rhs.scenario.payload), rhs.url_order_index, rhs.transport,
                                 rhs.scenario.url, rhs.scenario.qos_profile, rhs.scenario.properties,
                                 rhs.scenario.pub_properties, rhs.scenario.sub_properties, rhs.scenario.publishers,
                                 rhs.scenario.subscribers, rhs.scenario.payload_size, rhs.scenario.rate_hz,
                                 rhs.scenario.burst_messages, rhs.scenario.subscriber_sleep_us, rhs.scenario.warmup_ms,
                                 rhs.scenario.duration_ms, rhs.scenario.drain_ms);
  });
