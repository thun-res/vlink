...
description: >-
  ...
  vlink-test、C API 与 Python 绑定,运行完整 CTest、绑定测试或指定
  suite/case 并汇总失败。用户要求"跑 test"、"执行单元测试"、
  "测试 c_api/python_api"、"只测某个 suite/case"、"验证测试是否通过"
  或排查非 ASan 的 ci-test 失败时使用。
---
