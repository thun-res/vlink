...
| C/Python API、Doxygen | `c_api/`、`python_api/`、公开头 | 派生面 |
| 测试与示例 | `test/`、`examples/`、`python_api/{test,examples}/` | 验证与用法 |
| Agent 索引与规则 | `.agents/`、`AGENTS.md` | 路由与约束 |
...
`.agents/FEATURE-INDEX.md` 建立功能全集,逐项核对所有派生面。记录审计
基线、实际文件范围和任何排除项。
