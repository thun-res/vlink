...
vlink_progress_run "Stage portable runtime" bash "${script_dir}/stage-linux-portable-runtime.sh" build-conan/packup/linux/vlink
...
vlink_progress_run "Check runtime closure" bash "${script_dir}/check-linux-runtime-closure.sh"
