...
(() => {
  ...
  const checkEnvItems = [
    ...
    ['VLINK_LOG_PID_DIR', '', 'When set to 1 isolates log files under application-name/PID so concurrent instances of one application do not share a rotating file set.', false],
