...
``languages/python_api/test/``.  Tests validate the binding contract; this file
...
def demo_pubsub_flatbuffers():
    ...
    runtime and the schema generated by ``flatc --python``::
        ...
        flatc --python -o languages/python_api/ test/idl/test.fbs
...
def demo_pubsub_point_cloud():
    ...
    for seq in (1, 2, 3):
        ...
        # Vertical layout may be toggled after create; it affects only the
        # serialized wire payload, not the in-memory row-major point buffer.
