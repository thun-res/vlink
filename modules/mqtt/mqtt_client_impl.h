...
// MqttClientImpl
class MqttClientImpl final : public ClientImpl, public AbstractNode {
 public:
  using Object = MqttClient;
  static constexpr uint8_t kImplType = kClient;

  explicit MqttClientImpl(const MqttConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(MqttClientImpl)
};
