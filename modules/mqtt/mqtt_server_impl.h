...
// MqttServerImpl
class MqttServerImpl final : public ServerImpl, public AbstractNode {
 public:
  using Object = MqttServer;
  static constexpr uint8_t kImplType = kServer;

  explicit MqttServerImpl(const MqttConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(MqttServerImpl)
};
