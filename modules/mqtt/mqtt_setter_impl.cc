...
// MqttSetterImpl
MqttSetterImpl::MqttSetterImpl(const MqttConf& conf) : conf_(conf) {}

void MqttSetterImpl::init() {
...
void MqttSetterImpl::deinit() {
  detach();

  object_->remove_impl(this);
}

const Conf* MqttSetterImpl::get_conf() const { return &conf_; }

const AbstractNode* MqttSetterImpl::get_abstract_node() const { return object_.get(); }

void MqttSetterImpl::write(const Bytes& msg_data) {
