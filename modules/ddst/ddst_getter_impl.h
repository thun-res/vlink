...
// DdstGetterImpl
class DdstGetterImpl final : public GetterImpl, public AbstractNode {
 public:
  // ReaderListener
  ...
  explicit DdstGetterImpl(const DdstConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdstGetterImpl)
};
