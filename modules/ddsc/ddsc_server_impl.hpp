...
// DdscServerImpl
class DdscServerImpl final : public ServerImpl, public AbstractNode {
 public:
  // WriterListener
  ...
  explicit DdscServerImpl(const DdscConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdscServerImpl)
};
