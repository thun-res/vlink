...
// DdscSubscriberImpl
class DdscSubscriberImpl final : public SubscriberImpl, public AbstractNode {
 public:
  // ReaderListener
  ...
  explicit DdscSubscriberImpl(const DdscConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdscSubscriberImpl)
};
