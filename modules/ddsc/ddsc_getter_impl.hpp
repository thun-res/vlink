...
// DdscGetterImpl
class DdscGetterImpl final : public GetterImpl, public AbstractNode {
 public:
  // ReaderListener
  ...
  explicit DdscGetterImpl(const DdscConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdscGetterImpl)
};
