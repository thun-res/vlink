...
// DdsrSetterImpl
class DdsrSetterImpl final : public SetterImpl, public AbstractNode {
 public:
  // WriterListener
  ...
  explicit DdsrSetterImpl(const DdsrConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdsrSetterImpl)
};
