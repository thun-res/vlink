...
// DdsrPublisherImpl
class DdsrPublisherImpl final : public PublisherImpl, public AbstractNode {
 public:
  // WriterListener
  ...
  explicit DdsrPublisherImpl(const DdsrConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdsrPublisherImpl)
};
