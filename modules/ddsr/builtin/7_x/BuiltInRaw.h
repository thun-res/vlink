...
NDDSUSERDllExport RTIXCdrTypePlugin* vlink_BuiltInRaw_get_type_plugin_info(void);
NDDSUSERDllExport RTIXCdrSampleAccessInfo* vlink_BuiltInRaw_get_sample_access_info(void);
#endif
...
NDDSUSERDllExport RTIBool vlink_BuiltInRaw_finalize_w_return(vlink_BuiltInRaw* self);
