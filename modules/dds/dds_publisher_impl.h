...
// DdsPublisherImpl
class DdsPublisherImpl final : public PublisherImpl, public AbstractNode {
 public:
  // WriterListener
  ...
  explicit DdsPublisherImpl(const DdsConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdsPublisherImpl)
};
