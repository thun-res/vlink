...
// DdsSubscriberImpl
class DdsSubscriberImpl final : public SubscriberImpl, public AbstractNode {
 public:
  // ReaderListener
  ...
  explicit DdsSubscriberImpl(const DdsConf& conf);
 ...
 private:
  ...
  std::shared_ptr<dds::Topic> topic_;
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(DdsSubscriberImpl)
};
