...
// ZenohServerImpl
class ZenohServerImpl final : public ServerImpl, public AbstractNode {
 public:
  using Object = ZenohServer;
  static constexpr uint8_t kImplType = kServer;

  explicit ZenohServerImpl(const ZenohConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(ZenohServerImpl)
};
