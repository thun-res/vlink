...
// ZenohClientImpl
class ZenohClientImpl final : public ClientImpl, public AbstractNode {
 public:
  using Object = ZenohClient;
  static constexpr uint8_t kImplType = kClient;

  explicit ZenohClientImpl(const ZenohConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(ZenohClientImpl)
};
