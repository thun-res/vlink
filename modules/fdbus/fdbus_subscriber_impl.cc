...
// FdbusSubscriberImpl
FdbusSubscriberImpl::FdbusSubscriberImpl(const FdbusConf& conf) : conf_(conf) {}

void FdbusSubscriberImpl::init() {
...
void FdbusSubscriberImpl::deinit() { object_->remove_impl(this); }

bool FdbusSubscriberImpl::suspend() {
  has_suspend = true;

  return true;
}

bool FdbusSubscriberImpl::resume() {
  has_suspend = false;

  return true;
}

bool FdbusSubscriberImpl::is_suspend() const { return has_suspend; }

const Conf* FdbusSubscriberImpl::get_conf() const { return &conf_; }

const AbstractNode* FdbusSubscriberImpl::get_abstract_node() const { return object_.get(); }

bool FdbusSubscriberImpl::attach(class MessageLoop*) {
  VLOG_W("Function [attach] is not supported.");
  return false;
}

bool FdbusSubscriberImpl::detach() {
...
void FdbusSubscriberImpl::subscribe() {
