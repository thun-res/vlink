...
// ShmClientImpl
class ShmClientImpl final : public ClientImpl, public AbstractNode {
 public:
  using Object = ShmClient;
  static constexpr uint8_t kImplType = kClient;

  explicit ShmClientImpl(const ShmConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(ShmClientImpl)
};
