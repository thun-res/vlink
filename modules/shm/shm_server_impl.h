...
// ShmServerImpl
class ShmServerImpl final : public ServerImpl, public AbstractNode {
 public:
  using Object = ShmServer;
  static constexpr uint8_t kImplType = kServer;

  explicit ShmServerImpl(const ShmConf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(ShmServerImpl)
};
