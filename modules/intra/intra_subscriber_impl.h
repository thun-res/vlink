...
class IntraSubscriberImpl final : public SubscriberImpl {
 ...
 private:
  ...
  bool listen(IntraMsgCallback&& callback) override;

  IntraType type_{IntraType::kQueue};
  IntraConf conf_;
  std::shared_ptr<Object> object_;

  VLINK_DISALLOW_COPY_AND_ASSIGN(IntraSubscriberImpl)
};
