...
class IntraPublisherImpl final : public PublisherImpl {
 ...
 private:
  ...
  bool write(const IntraData& intra_data) override;

  IntraType type_{IntraType::kQueue};
  IntraConf conf_;
  std::shared_ptr<Object> object_;

  VLINK_DISALLOW_COPY_AND_ASSIGN(IntraPublisherImpl)
};
