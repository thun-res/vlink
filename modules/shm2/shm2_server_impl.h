...
// Shm2ServerImpl
class Shm2ServerImpl final : public ServerImpl, public AbstractNode {
 public:
  using Object = Shm2Server;
  static constexpr uint8_t kImplType = kServer;

  explicit Shm2ServerImpl(const Shm2Conf& conf);
 ...
 private:
  ...
  VLINK_DISALLOW_COPY_AND_ASSIGN(Shm2ServerImpl)
};
